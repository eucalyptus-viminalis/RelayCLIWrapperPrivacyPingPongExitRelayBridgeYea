...
export const DEFAULT_MNEMONIC_ENV_VAR = 'RELAY_MNEMONIC';
export const DEFAULT_MNEMONIC_ADDRESS_INDEX = 0;
export const MNEMONIC_ADDRESS_INDEX_ENV_VAR = 'RELAY_MNEMONIC_ADDRESS_INDEX';
